...
/**
 * @phpstan-type CreateUCGSDataType array{}
 * @extends AbstractInputFilter<CreateUCGSDataType>
 */
class CreateUCGSInputFilter extends AbstractInputFilter
{
    public function init(): self
    {
        ...
        return $this
            ...
            ->add(new CsrfInput('createUCGSCsrf', true));
    }
}
